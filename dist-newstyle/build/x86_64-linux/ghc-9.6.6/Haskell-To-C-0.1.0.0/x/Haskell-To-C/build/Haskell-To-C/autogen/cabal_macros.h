...
/* package Haskell-To-C-0.1.0.0 */
#ifndef VERSION_Haskell_To_C
#define VERSION_Haskell_To_C "0.1.0.0"
#endif /* VERSION_Haskell_To_C */
#ifndef MIN_VERSION_Haskell_To_C
#define MIN_VERSION_Haskell_To_C(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Haskell_To_C */
...
#define CURRENT_COMPONENT_ID "Haskell-To-C-0.1.0.0-inplace-Haskell-To-C"
